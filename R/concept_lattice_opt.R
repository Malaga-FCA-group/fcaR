...
#' @import R6
#'
ConceptLattice_opt <- R6::R6Class(

  classname = "ConceptLattice_opt",
  ...
  public = list(
    ...
    #' @description
    #' Create a new \code{ConceptLattice_opt} object.
    #'
    ...
    #'
    #' @return
    #' A new \code{ConceptLattice_opt} object.
    #'
    #' @export
    ...
    sublattice2 = function(...) {
      ...
      if (length(idx) > 0) {
        ...
        cl <- ConceptLattice_opt$new(extents = my_extents,
                                 intents = my_intents,
                                 objects = private$objects,
                                 attributes = private$attributes,
                                 I = private$I)
